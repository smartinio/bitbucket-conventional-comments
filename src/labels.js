...
export const semanticLabels = {
  ...
  polish: {
    text: 'polish',
    description: 'Polish comments are like a suggestion, where there is nothing necessarily wrong with the relevant content, there\'s just some ways to immediately improve the quality.',
    icon: icons.polishIcon,
    hasBlockingOption: true,
  },
  quibble: {
    text: 'quibble',
    description: 'Quibbles are very much like nitpick:, except it does not conjure up images of lice and animal hygiene practices.',
